...
struct ListNode
{
    ...
    ListNode *next;
    ListNode *prev;
    ListNode(const int val, ListNode *next = nullptr, ListNode *prev = nullptr) : val{val}, next{next}, prev{prev} {}
};
...
inline bool DCLL::push_back(const int &ele)
{
    if (head == nullptr)
    {
    ...
    else
    {
        ...
        curr->next = new ListNode(ele, head, curr);
    }
    size++;
    return true;
}

inline bool DCLL::push_front(const int &ele)
{
    if (head == nullptr)
    {
        head = new ListNode(ele);
...
inline bool DCLL::add_element(const size_t index, const int &ele)
{
    ...
    else
    {
        ...
        ListNode *newNode = new ListNode(ele, curr, prev);
        prev->next = newNode;
        curr->prev = newNode;
        size++;
    }
...
inline bool DCLL::insertAfterValue(int val, const int &afterVal)
{
    if (isEmpty())
    {
...
int DCLL::find(const int &val) const
{
...
bool DCLL::search(const int &val) const
{
...
inline int DCLL::delete_element(const int &ele)
{
    if (head == nullptr)
    {
        throw runtime_error("List in empty");
...
int DCLL::deleteAtPos(const int &pos)
{
    if (isEmpty())
    {
        throw runtime_error("List in empty");
...
int main()
{
    ...
    while (true)
    {
        ...
        cout << "11. Print" << endl;
        cout << "12. Size of DCLL currently" << endl;
        cout << "0. EXIT" << endl;
        cout << "Choice --> ";
        int choice;
        cin >> choice;
        ...
        case 4:
        {
            ...
            {
                cout << "Error: Ref element not found" << endl;
                ;
            }
            break;
        }
        ...
        case 9:
        {
            ...
            {
                cout << ele << " location is DCLL : " << location << endl;
            }
            else
            {
        ...
        case 10:
        {
            ...
            if (location)
            {
                cout << ele << " exist in DCLL " << endl;
            }
            else
            {
                cout << ele << " does not exist in DCLL " << endl;
            }
            break;
        }
        case 11:
